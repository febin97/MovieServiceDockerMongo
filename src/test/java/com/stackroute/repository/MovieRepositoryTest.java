...
public class MovieRepositoryTest {
    ...
    public void testAddNewMovie(){
        ...
        Assert.assertEquals(123,fetchMovie.getMovieId());
    }
    ...
    public void testFindByName(){
        ...
        Assert.assertEquals(123,fetchMovie.get(0).getMovieId());
    }
    @Test
    public void testFindByNameFailure(){
        movieRepository.save(movie);
        List<Movie> fetchMovie = movieRepository.getMovieWithTitle(movie.getMovieTitle());
        Assert.assertNotEquals(java.util.Optional.of(2),fetchMovie.get(0).getMovieId());
    }
    @Test
